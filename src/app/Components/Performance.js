    ...
    return (
        <div className="mt-8 w-full lg:w-11/12 bg-white shadow-md rounded-md overflow-hidden">
            <div className="px-6 py-4">
                ...
                <div className='flex flex-row  item-center justify-center gap-3 mb-4'>
                    <div class='flex flex-col'>
                        ...
                        <div class="font-inter text-base font-medium leading-5 text-gray-900 p-4 ">
                           
                        </div>
                    </div>

                    <div class="h-2 bg-gradient-to-r from-red-500 via-orange-500 to-green-500 rounded-md w-8/12 mt-5"></div>
                ...
                <div className='flex flex-row  item-center justify-center gap-3 mb-5'>
                    <div class='flex flex-col'>
                        <div classname='flex flex-col items-center justify-center'>
                            <h2 className='font-inter text-base font-medium leading-5 text-gray-500'>Today's Low</h2>
                            <h2 className='mt-4'> 46,930.22</h2>
                ...
                <div className='flex flex-row gap-40'>
                    <div className='flex flex-col'>
                        <InfoRow
                            leftText="Bitcoin Price"
                            rightText="$16,815.46"
                        />
                        <InfoRow
                            leftText="24h Low / 24h High"
                            rightText="$16,815.46"
                        /> <InfoRow
                            leftText="Bitcoin Price"
                            rightText="$16,815.46"
