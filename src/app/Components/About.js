...
const ProfileCard = ({ profilePic, colors, name }) => {
    return (
        <div className={`flex flex-col lg:flex-row rounded-xl ${colors}`}>
            ...
            <div className="flex flex-col justify-center lg:w-2/3">
                <div className="flex flex-col items-center lg:items-start lg:ml-4 mt-4 lg:mt-0">
                    <h2 className="text-white font-semibold text-center lg:text-left">{name}</h2>
                </div>
    ...
    return (
        <div className="mt-8 w-full lg:w-11/12 bg-white shadow-md rounded-md overflow-hidden">
            <div className="px-6 py-4">
                ...
                <div className='mb-5'>
                    <h2 className="font-bold leading-5 text-left text-xl">What is Bitcoin?</h2>
                </div>
                <div>
            ...
            <div className='mb-4'>
                <h2 className="font-bold leading-5 text-left text-xl ml-6">Lorem ipsum dolor sit amet</h2>
            </div>
            <div className='ml-5'>
